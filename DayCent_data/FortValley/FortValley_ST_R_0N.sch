...
Year Month Option
1            Block # Strip tillage with rye crop and 0 kg N
2002         Last year
4            Repeats # years
...
2  123  CULT   ROW          # Check if this CULT event is correct for strip-tillage
...
3  122  CULT   ROW          # Check if this CULT event is correct for strip-tillage
...
4  122  CULT   ROW          # Check if this CULT event is correct for strip-tillage
