...
Year Month Option
1            Block # Strip tillage with hairy vetch/rye crop and 0 kg N
2002         Last year
4            Repeats # years
...
1  290  CROP  MXNL         # Mix hairy vetch/rye crop
1  290  PLTM
2  106  LAST
2  106  HARV  MOW          # CUT cc and spread in the fields
2  106  CULT  HERB         # Herbicide to kill cc
2  123  CULT  ROW          # Check if this is OK for strip tillage
...
2  294  CROP  MXNL         # Mix hairy vetch/rye crop
2  294  PLTM
3  105  LAST
3  105  HARV  MOW          # CUT cc and spread in the fields
3  105  CULT  HERB         # Herbicide to kill cc 
3  122  CULT  ROW          # Check if this is OK for strip tillage
...
3  293  CROP  MXNL         # Mix hairy vetch/rye crop
3  293  PLTM
4  105  LAST
4  105  HARV  MOW          # CUT cc and spread in the fields
4  105  CULT  HERB         # Herbicide to kill cc 
4  122  CULT  ROW          # Check if this is OK for strip tillage
